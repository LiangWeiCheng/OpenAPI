package com.womai.mobile.api.service.common.redis.impl;
import com.womai.mobile.api.common.util.SerializeUtil;
...
public class RedisObjectServiceImpl implements RedisObjectService {
    ...
    //        @Override public String setObject(final Pair<String,ProductList> pair,final int second) {
//
//        return new Executor<String>(shardedJedisPool) {
//
//            @Override
//            String execute() {
//
//                return jedis.setex(pair.getKey().getBytes(),second, SerializeUtil.serialize(pair.getValue()));
//            }
//        }.getResult();
//
//    }
    ...
    public <T> T getObject(final String key, Class<T> type) {
        ...
        return (T) SerializeUtil.unserialize(new Executor<byte[]>(shardedJedisPool) {
    ...
    public List<Object>  getObjectList(final List<String> key, Object object) {
        ...
        for(String k:key){
            list.add(getObject(k,object.getClass()));
        }
        return list;
    }
    ...
    public String setObject(String key,Object object, final int second) {
        final Pair<String,Object> pair = makePair(key,object);
        return new Executor<String>(shardedJedisPool) {
            @Override
            String execute() {
    ...
    public String setObjectNx(final Pair<String, Object> pair) {
        ...
        return new Executor<String>(shardedJedisPool) {
            ...
            String execute() {
                ...
                return jedis.set(pair.getKey().getBytes(),SerializeUtil.serialize(pair.getValue())).toString();
            }
        }.getResult();
