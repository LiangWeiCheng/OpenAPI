 ...
 */
@Service("cmsRequest")
public class CmsRequest extends BaseService implements IServerRequest {
    ...
    public ResponseVO httpRequest(ValidationInfo validationInfo, Map<String, String> paramsMap, String requestType, String requestPath) throws Exception {
        ...
        if(result != null && !result.equals("")) {
            ...
            String msg = ResponseUtil.getMessage(Constant.CMS_RETURNNULL);
            responseVO = ResponseUtil.getResponseVO(Constant.CMS_RETURNNULL, msg);
        }
        return responseVO;
    }
}
